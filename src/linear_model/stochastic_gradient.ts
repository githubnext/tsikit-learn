...
export function epsilonInsensitiveLossGrad(
  y: number,
  f: number,
  eps = 0.1,
): number {
...
export function evalLoss(
  ...
  switch (loss) {
    case "squared":
      return squaredLoss(y, f);
    case "hinge":
      return hingeLoss(y, f);
    case "squared_hinge":
      return squaredHingeLoss(y, f);
    case "log":
      return logLossFn(y, f);
    case "epsilon_insensitive":
      return epsilonInsensitiveLoss(y, f, extra);
    case "huber":
      return huberLossFn(y, f, extra);
  }
}

/** Evaluate loss gradient for a named loss function. */
export function evalLossGrad(
  loss: LossFunction,
  y: number,
  f: number,
  extra = 0.1,
  ...
  switch (loss) {
    case "squared":
      return squaredLossGrad(y, f);
    case "hinge":
      return hingeLossGrad(y, f);
    case "squared_hinge":
      return squaredHingeLossGrad(y, f);
    case "log":
      return logLossGrad(y, f);
    case "epsilon_insensitive":
      return epsilonInsensitiveLossGrad(y, f, extra);
    case "huber":
      return huberLossGrad(y, f, extra);
  }
}
