...
- **Recovery range tracking**: ext1-18 survive branch resets. ext356-410 added in iter 139. **Next recovery range**: ext411-465
...
- Next recovery: use ext411-465 range (55 files per module × 35 modules = 1925 files)
